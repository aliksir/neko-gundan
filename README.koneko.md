...
- **No heavy features (v1.10.x–v1.11.x)** — Adversarial 2nd-Pass, Evidence Level Ladder, Exploration mode, nightly-runner, kill-switch/steer hooks, and Dynamic Workflows are full Neko Gundan only
